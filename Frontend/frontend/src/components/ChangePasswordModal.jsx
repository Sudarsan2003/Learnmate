  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <form
        ...
        className="w-full max-w-sm space-y-4 rounded-2xl border border-[#2DD4BF]/20 bg-[var(--surface)]/95 p-6 shadow-2xl shadow-black/50 backdrop-blur-xl"
      >
        <div className="flex items-center justify-between">
          <h2 className="flex items-center gap-2 font-serif text-lg text-[var(--text)]">
